...
const metrics = replay(raw && raw.recommendations ? raw.recommendations : raw, surface ? { surface } : undefined);
console.log(JSON.stringify({ file: resolved, surface: surface || 'all', metrics }, null, 2));
