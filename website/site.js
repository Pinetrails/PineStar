...
(function(){
  ...
  // pricing.html and the links come back everywhere at once — EXCEPT the docs pages, which do
  // not load this script (adding it there would break the privacy page's "the download page
  // makes ONE api.github.com request" disclosure), so their topnav PRICING entry was deleted
  // outright and has to be re-added by hand: `<a href="../pricing.html">PRICING</a>`.
