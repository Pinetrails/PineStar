...
// ---- A. resolveTools (pure projection) ----
{
  ...
  A.eq(full.tools.slice().sort(), ['notebook.feedback', 'notebook.read', 'notebook.write', 'recall_conversation', 'skill.list', 'skill.view', 'skill.write', 'todo'], 'notebook grants its tools; compute excluded from tools[]');
  ...
  A.eq(split.tools.slice().sort(), ['notebook.feedback', 'notebook.read', 'notebook.write', 'recall_conversation', 'skill.list', 'skill.view', 'skill.write', 'todo'], 'only assigned-room objects grant tools');
  ...
  A.eq(dup.tools.slice().sort(), ['notebook.feedback', 'notebook.read', 'notebook.write', 'recall_conversation', 'skill.list', 'skill.view', 'skill.write', 'todo'], 'duplicate objects de-duped');
