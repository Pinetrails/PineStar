...
// The chip exists on the connect screen and ships HIDDEN — only the live linkable/configured probe reveals it.
ok(/class="prov hidden" data-prov="starnet"/.test(index), 'the STARNET chip ships hidden (honesty: no cloud, no offer)');
...
ok(/revealStarnetGenesis\(\)/.test(app), 'the connect screen actually runs the reveal');
