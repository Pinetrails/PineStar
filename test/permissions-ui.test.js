...
ok(/<details class="perm-fold" id="perm-finetune">/.test(src) && /<summary>Set up crew members individually<\/summary>/.test(src),
  'the per-crew controls, override, ladder and ledger all sit behind one closed fold');
