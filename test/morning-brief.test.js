...
] }, { id: 'product-research:trail-kit', type: 'product-research-decision', createdAt: end - 2, decisions: ['GO: Evidence supports planning.'], nextActions: ['Prepare the bounded product plan.'] }], runs: [{ runId: 'r1', ts: end - 3, usd: 0.125 }, { runId: 'old-run', ts: start, usd: 9 }], businessSummary: { entryCount: 2, revenueUsd: 12.5, expenseUsd: 2, refundUsd: 0, netUsd: 10.5, sourceRefs: ['business-entry:sale-1', 'business-entry:fee-1'] } });
