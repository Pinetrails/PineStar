...
] }, { id: 'product-research:trail-kit', type: 'product-research-decision', createdAt: end - 2, decisions: ['GO: Evidence supports planning.'], nextActions: ['Prepare the bounded product plan.'] }], runs: [{ runId: 'r1', ts: end - 3, usd: 0.125 }, { runId: 'old-run', ts: start, usd: 9 }] });
