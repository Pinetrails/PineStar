...
A.ok(report.decisions.includes('challenger_recommended: advisory evidence only.') && report.nextActions.includes('Commander review is required before any configuration change.'), 'advisory evaluation outcome enters the Morning Brief without activation');
