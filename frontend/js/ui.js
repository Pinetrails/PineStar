...
const UI = (() => {
  ...
  function buildSettings(body) {
    ...
    body.innerHTML =
      ...
      '<p class="set-about">STARNET STATION OS v2.077 — autosaves every 30s.<br>17 agents · STARNET/OPENCLAW harnesses · simulated GPT 5.5 / OPUS 4.8 / FABLE 5 workloads.</p>';
