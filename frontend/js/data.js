...
/* ============ AGENTS ============ */
/* harness: STARNET | OPENCLAW ; model: FABLE | OPUS | GPT */
DATA.AGENTS = [
  ...
  { id: 'NOVA',       room: 'research',   color: '#4ad9ff', harness: 'STARNET', model: 'OPUS',
  ...
  { id: 'CURIE',      room: 'research',   color: '#8f7bff', harness: 'STARNET', model: 'GPT',
  ...
  { id: 'FORGE',      room: 'factory1',   color: '#ff9d2e', harness: 'STARNET', model: 'GPT',
  ...
  { id: 'VECTOR',     room: 'factory1',   color: '#ffd34a', harness: 'STARNET', model: 'GPT',
  ...
  { id: 'PROMETHEUS', room: 'factory1',   color: '#ff6ad5', harness: 'STARNET', model: 'GPT',
  ...
  { id: 'PIXEL',      room: 'factory2',   color: '#41ff8a', harness: 'STARNET', model: 'GPT',
  ...
  { id: 'ATLAS',      room: 'factory2',   color: '#2ee6c8', harness: 'STARNET', model: 'GPT',
  ...
  { id: 'QUILL',      room: 'factory2',   color: '#d8c9a3', harness: 'STARNET', model: 'GPT',
  ...
  { id: 'CIPHER',     room: 'factory2',   color: '#7fd0ff', harness: 'STARNET', model: 'GPT',
    role: 'SAAS FOUNDRY',
  ...
  { id: 'VYBES',      room: 'factory2',   color: '#b44aff', harness: 'STARNET', model: 'GPT',
    role: 'DJ — MUSIC BAY',
  ...
  { id: 'HERALD',     room: 'publishing', color: '#ffe066', harness: 'STARNET', model: 'GPT',
  ...
  { id: 'LEDGER',     room: 'treasury',   color: '#9bff4a', harness: 'STARNET', model: 'GPT',
  ...
  { id: 'ATHENA',     room: 'warroom',    color: '#ff5c7a', harness: 'STARNET', model: 'GPT',
  ...
  { id: 'RAVEN',      room: 'warroom',    color: '#a0a8ff', harness: 'STARNET', model: 'GPT',
  ...
  { id: 'RELAY',      room: 'comms',      color: '#5ad1b3', harness: 'STARNET', model: 'GPT',
  ...
  { id: 'SCRIBE',     room: 'archives',   color: '#c0c0c0', harness: 'STARNET', model: 'GPT',
    role: 'ARCHIVIST',
