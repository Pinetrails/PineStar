...
(function () {
  ...
  const DEPTH_DEFAULTS = { wallShadow: 0.5, sheen: 0.14, cornerAO: 0.55, dither: 0.15, floorWear: 0.55, floorDetail: 1 };
  ...
  const PRESETS = {
    ...
    'Flat (old)':      { wall: { up: 0, corUp: 0, skirt: 12, side: 4 }, depth: { wallShadow: 0, sheen: 0, cornerAO: 0, dither: 0, floorWear: 0, floorDetail: 0 } },
    'Tall halls':      { wall: { up: 10, corUp: 0, skirt: 32, side: 12 } },
    'Towering':        { wall: { up: 32, corUp: 15, skirt: 38, side: 9 } },
    'Depth+':          { crt: { dust: 0.5, aberr: 0.35, grain: 0.24 }, depth: { wallShadow: 0.5, sheen: 0.14, cornerAO: 0.55, dither: 0.15, floorWear: 0.55, floorDetail: 1 } },
  };
