/* SKYNET — specialties.js : preset SPECIALTY types for agents — the "what it's FOR" axis.
   ...
   Parallel to personas.js (the "how it TALKS" axis). The two compose: a "Deadpan Researcher"
   is a Researcher specialty wearing the deadpan-bot persona. A specialty bundles a ready-made
...
(function (root, factory) {
  ...
  function freezeSpec(s) {
    return Object.freeze({
      ...
      persona: s.persona || 'confidant',              // recommended personaId (the Commander can override)
  ...
  const BUILTINS = Object.freeze([
    {
      ...
      persona: 'straight-shooter', model: 'balanced', accent: '#46c8ff',
      tags: { research: 1 },
    ...
    },
    {
      ...
      persona: 'straight-shooter', model: 'reasoning', accent: '#7df0a0',
      tags: { code: 1 },
    ...
    },
    {
      ...
      persona: 'veteran', model: 'balanced', accent: '#ffb641',
    ...
    },
    {
      ...
      persona: 'confidant', model: 'balanced', accent: '#e6a0ff',
      tags: { general: 1 },
    ...
    },
    {
      ...
      persona: 'straight-shooter', model: 'reasoning', accent: '#6cd0ff',
    ...
    },
    {
      ...
      persona: 'dry-wit', model: 'reasoning', accent: '#ff8f8f',
    ...
    },
    {
      ...
      persona: 'straight-shooter', model: 'fast', accent: '#46c8ff',
    ...
    },
    {
      ...
      persona: 'veteran', model: 'balanced', accent: '#c8efff',
    ...
    },
    {
      ...
      persona: 'confidant', model: 'balanced', accent: '#ffd34a',
      tags: { general: 1 },
    ...
    },
    {
      ...
      persona: 'confidant', model: 'balanced', accent: '#ffaa33',
      tags: { general: 1 },
    ...
    },
    {
      ...
      persona: 'confidant', model: 'balanced', accent: '#5fd0e0',
      tags: { general: 1 },
  ...
  function normCustom(s) {
    ...
    return {
      ...
      purpose, manual,
      persona: s.persona || 'confidant', model: TIERS[s.model] ? s.model : 'balanced',
  ...
  function fromAgent(agent, meta) {
    ...
    return {
      ...
      persona: (agent && agent.personaId) || 'confidant',
