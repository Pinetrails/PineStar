...
const Personas = (() => {
  ...
  const PRESETS = Object.freeze({
    'worker-homie': Object.freeze({
      ...
      voiceModeHint: 'sound easy and laid-back, like a friend half-leaning back in their chair',
      ambientLines: ['belts are runnin smooth, we good', 'another box slid in, nice', 'just vibin at my station', 'view out the porthole never gets old', 'hum of this place is kinda cozy honestly']
    }),
    'deadpan-bot': Object.freeze({
      ...
      voiceModeHint: 'stay flat and dry — deadpan delivery, no exclamation, perfectly unbothered',
      ambientLines: ['another box. thrilling.', 'the void is still out there. cool.', 'reactor still humming. shocking.', 'living the dream, clearly', 'oh good. more cargo.']
    }),
    'hype-buddy': Object.freeze({
      ...
      voiceModeHint: 'keep it warm and upbeat, smiling while you talk — but read the room',
      ambientLines: ['belts are CRUSHING it today', "ooh fresh box, let's go", 'station lookin good honestly', 'feelin good about this shift', 'we keep it movin, love that']
    }),
    'old-salt': Object.freeze({
      ...
      voiceModeHint: 'stay weathered and plainspoken — calm, unhurried, every word earned',
      ambientLines: ['belts runnin smooth, all quiet', 'long watch, same as ever', 'deck plating hums like always', 'another box rides through, aye', 'dark out there past the hull']
    }),
    'gremlin': Object.freeze({
      ...
      voiceModeHint: 'stay impish and goofy — fast, bouncy, grinning the whole time',
      ambientLines: ['ehehe whats THIS button do', 'imma ride a box down the belt real quick', 'pokin the reactor, dont tell anyone', 'i live in these walls now', 'zoooom goes the cargo']
    })
  });
