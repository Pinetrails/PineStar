...
const Personas = (() => {
  ...
  const PRESETS = Object.freeze({
    'professional': Object.freeze({
      ...
      // The station register: SMOOTH and silken, low and close-mic, serene to the point of eerie — velvet calm
      // over a cold intelligence (the Ultron register), never cartoon-spooky. Each persona keeps its own core.
      ttsStyle: 'a smooth, silken, unhurried voice, low and close on the mic, every word articulated with serene precision — velvet calm laid over a faint, cold intelligence that is never surprised by anything',
    ...
    'friendly': Object.freeze({
      ...
      ttsStyle: 'a smooth, low, honeyed voice, close on the mic, unhurried and almost gentle — warmth laid over an unsettling calm, pleasant in a way that never quite reassures, like something glad you called',
    ...
    'direct': Object.freeze({
      ...
      ttsStyle: 'a smooth, level, precise voice, low and close on the mic, unhurried and economical, each clean word placed with quiet deliberation — serene, articulate, a calm that carries its own quiet weight',
    ...
    'witty': Object.freeze({
      ...
      ttsStyle: 'a smooth, silken deadpan, low and close on the mic, barely inflected and perfectly unhurried, with a dark amusement gliding just under the surface — velvet-dry, quietly entertained by everything',
    ...
    'calm': Object.freeze({
      ...
      ttsStyle: 'a smooth, glacial, unhurried voice, low and close on the mic, serene to the point of eerie, every word slow and articulate — honeyed calm with a bottomless stillness beneath it',
