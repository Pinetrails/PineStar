...
const Personas = (() => {
  ...
  const PRESETS = Object.freeze({
    'worker-homie': Object.freeze({
      ...
      acks: ['aight, on it', 'yeah, gimme a sec', 'lemme check real quick', 'on it, boss', 'say no more, doin it now', 'cool, gettin on that']
    }),
    'deadpan-bot': Object.freeze({
      ...
      acks: ['...on it.', 'sure. thrilling.', 'if i must.', 'fine, doing it.', 'yeah yeah, on it.', 'a task. how novel.']
    }),
    'hype-buddy': Object.freeze({
      ...
      acks: ['yo, on it!', "let's gooo, on it!", 'say less, i got you!', 'right away, love it!', "on it, this'll be good!", "you got it, i'm on it!"]
    }),
    'old-salt': Object.freeze({
      ...
      acks: ['aye, on it', 'consider it done', "i'll see to it, Commander", 'right away', "on it, won't be long", 'understood, gettin to it']
    }),
    'gremlin': Object.freeze({
      ...
      acks: ['ehehe on it!', 'ooh a task, gimme gimme', 'yoink, doin it', 'on it on it on it', 'hehe watch this', "okayokay i'm goin"]
    })
  });
