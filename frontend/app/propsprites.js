...
const PropSprites = (() => {
  ...
  const CATALOG = [
    ...
    { id: "holotable", label: "HOLOTABLE", cat: "ops", w: 4, h: 2, animated: true, blocks: true },
    { id: "screens", label: "SCREENS", cat: "ops", w: 2, h: 1, animated: true, blocks: false },
    { id: "tank", label: "TANK", cat: "ops", w: 2, h: 1, animated: true, blocks: true },
    { id: "whiteboard", label: "WHITEBOARD", cat: "ops", w: 4, h: 1, animated: true, blocks: false },
    { id: "ticker", label: "TICKER", cat: "ops", w: 4, h: 1, animated: true, blocks: false },
    { id: "chartwall", label: "CHART WALL", cat: "ops", w: 3, h: 1, animated: true, blocks: false },
    { id: "wartable", label: "WAR TABLE", cat: "ops", w: 5, h: 2, animated: true, blocks: true },
    { id: "calwall", label: "CAL WALL", cat: "ops", w: 6, h: 1, animated: true, blocks: false },
    { id: "bridge_tacscreen", label: "TAC SCREEN", cat: "ops", w: 2, h: 1, animated: true, blocks: false },
    { id: "bridge_relaystack", label: "RELAY STACK", cat: "ops", w: 1, h: 2, animated: true, blocks: true },
    { id: "bridge_dispatch_pylon", label: "DISPATCH PYLON", cat: "ops", w: 1, h: 2, animated: true, blocks: true },
    { id: "bridge_orderqueue", label: "ORDER QUEUE", cat: "ops", w: 2, h: 1, animated: true, blocks: true },
    { id: "war_pivotpanel", label: "PIVOT PANEL", cat: "ops", w: 2, h: 1, animated: true, blocks: true },
    { id: "war_intelcab", label: "INTEL CAB", cat: "ops", w: 1, h: 2, animated: true, blocks: true },
    { id: "war_threatcore", label: "THREAT CORE", cat: "ops", w: 1, h: 2, animated: true, blocks: true },
    { id: "fabricator", label: "FABRICATOR", cat: "lab", w: 3, h: 2, animated: true, blocks: true },
    { id: "vat", label: "VAT", cat: "lab", w: 3, h: 2, animated: true, blocks: true },
    { id: "easel", label: "EASEL", cat: "lab", w: 3, h: 2, animated: true, blocks: true },
    { id: "tube", label: "TUBE", cat: "lab", w: 2, h: 1, animated: true, blocks: true },
    { id: "core", label: "CORE", cat: "lab", w: 1, h: 2, animated: true, blocks: true },
    { id: "research_corelens", label: "CORE LENS", cat: "lab", w: 1, h: 2, animated: true, blocks: true },
    { id: "research_trendpillar", label: "TREND PILLAR", cat: "lab", w: 1, h: 2, animated: true, blocks: true },
    { id: "research_samplecart", label: "SAMPLE CART", cat: "lab", w: 2, h: 1, animated: true, blocks: true },
    { id: "research_papers", label: "PAPERS", cat: "lab", w: 2, h: 1, animated: true, blocks: false },
    { id: "etsy_threadrack", label: "THREAD RACK", cat: "lab", w: 2, h: 1, animated: true, blocks: true },
    { id: "etsy_dyevat", label: "DYE VAT", cat: "lab", w: 2, h: 2, animated: true, blocks: true },
    { id: "etsy_kiln", label: "KILN", cat: "lab", w: 2, h: 2, animated: true, blocks: true },
    { id: "etsy_packbot", label: "PACK BOT", cat: "lab", w: 2, h: 2, animated: true, blocks: true },
    { id: "rack", label: "RACK", cat: "storage", w: 2, h: 1, animated: true, blocks: true },
    { id: "rackV", label: "RACK V", cat: "storage", w: 1, h: 2, animated: true, blocks: true },
    { id: "crate", label: "CRATE", cat: "storage", w: 2, h: 1, animated: true, blocks: true },
    { id: "beltH", label: "CONVEYOR", cat: "storage", w: 2, h: 1, animated: true, blocks: true },
    { id: "boxes", label: "BOXES", cat: "storage", w: 2, h: 1, animated: true, blocks: true },
    { id: "vault", label: "VAULT", cat: "storage", w: 3, h: 2, animated: true, blocks: true },
    { id: "safe", label: "SAFE", cat: "storage", w: 1, h: 2, animated: true, blocks: true },
    { id: "goldcrate", label: "GOLD CRATE", cat: "storage", w: 2, h: 1, animated: true, blocks: true },
    { id: "parcels", label: "PARCELS", cat: "storage", w: 1, h: 2, animated: true, blocks: true },
    { id: "shelf", label: "SHELF", cat: "storage", w: 4, h: 1, animated: true, blocks: true },
    ...
    { id: "pub_publishpress", label: "PUBLISH PRESS", cat: "comms", w: 2, h: 2, animated: true, blocks: true },
    { id: "pub_outboundchute", label: "OUTBOUND CHUTE", cat: "comms", w: 1, h: 2, animated: true, blocks: true },
    { id: "pub_mailpod", label: "MAIL POD", cat: "comms", w: 2, h: 1, animated: true, blocks: true },
    { id: "arc_indexwall", label: "INDEX WALL", cat: "comms", w: 4, h: 1, animated: true, blocks: false },
    ...
    { id: "quarters_lockerbank", label: "LOCKERS", cat: "lounge", w: 3, h: 1, animated: true, blocks: true },
    { id: "quarters_minifridge", label: "MINIFRIDGE", cat: "lounge", w: 1, h: 1, animated: true, blocks: true },
    { id: "coffee", label: "COFFEE", cat: "decor", w: 1, h: 1, animated: true, blocks: false },
    { id: "plant", label: "PLANT", cat: "decor", w: 1, h: 1, animated: true, blocks: false },
    { id: "cans", label: "CANS", cat: "decor", w: 1, h: 1, animated: true, blocks: false },
    { id: "poster", label: "POSTER", cat: "decor", w: 1, h: 1, animated: true, blocks: false },
    { id: "rug", label: "RUG", cat: "decor", w: 4, h: 3, animated: true, blocks: false },
    { id: "treasury_pnl_holo", label: "PNL HOLO", cat: "decor", w: 1, h: 1, animated: true, blocks: false },
    { id: "arc_floorlight", label: "FLOOR LIGHT", cat: "decor", w: 1, h: 1, animated: true, blocks: false },
    { id: "arc_ladder", label: "LADDER", cat: "decor", w: 1, h: 1, animated: true, blocks: false },
  ];
  const BY_ID = {};
