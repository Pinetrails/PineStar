...
const PropSprites = (() => {
  ...
  const CATALOG = [
    ...
    { id: "intake", label: "INBOX", cat: "workflow", tier: "functional", w: 2, h: 2, animated: true, blocks: false, desc: "INBOX — where OUTSIDE work (a DM, a routine) arrives on the floor and drops onto a belt. You don't need one for an agent to work — a BAY alone is enough; the inbox is for watching outside work ride in." },
