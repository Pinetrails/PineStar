...
| Next goal | Add a safe, local report-export adapter contract and begin the extensible agent/objective registry foundation |
...
[Working rules](AGENTS.md) · [Detailed status](docs/CURRENT_STATUS.md) · [Roadmap](docs/ROADMAP.md) · [Decisions](docs/DECISIONS.md) · [Current change](docs/change-records/PS-2026-005.md) · [Docs index](docs/INDEX.md)
