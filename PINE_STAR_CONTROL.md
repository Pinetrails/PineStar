...
| Next goal | Resolve The Big Bite's 210-versus-213 scope and missing-DPI source decisions, then complete independent QA |
...
[Working rules](AGENTS.md) · [Detailed status](docs/CURRENT_STATUS.md) · [Roadmap](docs/ROADMAP.md) · [Decisions](docs/DECISIONS.md) · [Current change](docs/change-records/PS-2026-043.md) · [Docs index](docs/INDEX.md)
