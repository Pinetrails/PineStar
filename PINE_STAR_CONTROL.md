...
| Next goal | Add truthful commerce/store and revenue/expense records without external authority |
...
[Working rules](AGENTS.md) · [Detailed status](docs/CURRENT_STATUS.md) · [Roadmap](docs/ROADMAP.md) · [Decisions](docs/DECISIONS.md) · [Current change](docs/change-records/PS-2026-023.md) · [Docs index](docs/INDEX.md)
