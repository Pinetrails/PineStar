...
| Current change | `PS-2026-069` — Operational-Envelope Auditor Experiment — **AUTHORIZED; RUNNER READY, NOT YET EXECUTED** |
...
| Next goal | Execute the exact one-shot authorized plan, evaluate its six measured runs, and stop without activation |
...
[Working rules](AGENTS.md) · [Detailed status](docs/CURRENT_STATUS.md) · [Roadmap](docs/ROADMAP.md) · [Decisions](docs/DECISIONS.md) · [Current change](docs/change-records/PS-2026-069.md) · [Docs index](docs/INDEX.md)
