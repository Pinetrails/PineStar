...
| Next goal | Add project-control/status synchronization and a readable shared-report surface under `PS-2026-005` |
...
[Working rules](AGENTS.md) · [Detailed status](docs/CURRENT_STATUS.md) · [Roadmap](docs/ROADMAP.md) · [Decisions](docs/DECISIONS.md) · [Current change](docs/change-records/PS-2026-004.md) · [Docs index](docs/INDEX.md)
