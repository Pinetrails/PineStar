...
| Next goal | Review The Big Bite listing-ready evidence before creating a protected publication-review request |
...
[Working rules](AGENTS.md) · [Detailed status](docs/CURRENT_STATUS.md) · [Roadmap](docs/ROADMAP.md) · [Decisions](docs/DECISIONS.md) · [Current change](docs/change-records/PS-2026-046.md) · [Docs index](docs/INDEX.md)
