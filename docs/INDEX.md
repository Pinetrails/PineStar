...
- Hermes-parity program (design + loop workflow): `HERMES_INTEGRATION_PLAN.md`,
  `HERMES_PARITY_PLAN.md`, `HERMES_PARITY_LOOP_WORKFLOW.md`,
  `STARNET_HERMES_REPLACEMENT_LOOPS.md`, `STARNET_HERMES_REPLACEMENT_PHASE2.md`,
  `STARNET_HERMES_REPLACEMENT_PHASE3.md`, `STARNET_HERMES_REPLACEMENT_PHASE3_SEAL.md`,
  `STARNET_HERMES_REPLACEMENT_PHASE4.md`.
...
- Session/loop & task packs: `STARNET_SESSION_LOOPS_1_6.md`, `STARNET_BUG_FINDING_LOOPS.md`,
  `STARNET_DOGFOOD_TASK_PACK.md`, `STARNET_PHASE5_HERMES_WORKLOADS.md`.
...
- Phase-proof evidence, baselines & templates: `STARNET_PHASE4_BASELINE.md`,
  `STARNET_PHASE4_HERMES_BASELINE.md`, `STARNET_PHASE4_ATTENDED_EVIDENCE_TEMPLATE.md`,
